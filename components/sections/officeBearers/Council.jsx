                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        >
                            <div className="w-1/2 text-center">
                                Get acquainted with the Hall Council Members of
                                Patel Hall of Residence for the academic session{" "}
                                {params.session}. These leaders are at the
                                forefront of organizing events, addressing
                                concerns, and fostering a strong sense of
                                community.
                            </div>
                        </div>
                    </div>
