...
const UsersList = () => {
    const [patelians, setPatelians] = useState([]);
    ...
    const handleShowAddPost = async (id) => {
    ...
    const handleAddPost = async (index, post, portfolio, session) => {
        console.log(post);
